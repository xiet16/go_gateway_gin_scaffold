...
// 	ID          int64     `json:"id" form:"id" comment:"姓名" example:"" validate:"required"`
// 	ServiceName string    `json:"service_name" form:"service_name" comment:"姓名" example:"" validate:"required"`
// 	ServiceDesc string    `json:"service_desc" form:"service_desc" comment:"姓名" example:"" validate:"required"`
// 	Loadtype    int       `json:"load_type" form:"load_type" comment:"姓名" example:"" validate:"required"`
// 	UpdatedAt   time.Time `json:"update_at" form:"update_at" comment:"姓名" example:"" validate:"required"`
// 	CreatedAt   time.Time `json:"create_at" form:"create_at" comment:"姓名" example:"" validate:"required"`
// 	IsDelete    int       `json:"is_delete" form:"is_delete" comment:"是否删除" example:"" validate:"required"`
// }
